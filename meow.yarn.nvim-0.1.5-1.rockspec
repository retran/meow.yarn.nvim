...
description = {
   ...
   detailed = [[
      ...
      - Multi-Selection: Mark several nodes and send them to the quickfix list or trouble.nvim
      - Search, Sort and Filter: Filter nodes by name and cycle sort order on the fly
